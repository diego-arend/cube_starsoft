...
// to avoid loading heavy modules or NestJS parts before tracing starts.
...
const serviceName =
  process.env.BACKEND_OTEL_SERVICE_NAME ??
...
initObservability({
  OTEL_ENABLED:
    process.env.BACKEND_OTEL_ENABLED === "true" ||
  ...
  OTEL_EXPORTER_OTLP_ENDPOINT:
    process.env.BACKEND_OTEL_EXPORTER_OTLP_ENDPOINT ??
    process.env.OTEL_EXPORTER_OTLP_ENDPOINT,
  OTEL_EXPORTER_OTLP_PROTOCOL:
    process.env.BACKEND_OTEL_EXPORTER_OTLP_PROTOCOL ??
