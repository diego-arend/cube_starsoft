...
export class ConversationService {
  ...
  constructor(
    ...
    // metadata, so NestJS cannot resolve constructor deps by type alone.
    @Inject(AssistantConversationRepository)
    private readonly conversationRepo: AssistantConversationRepository,
    @Inject(AssistantMessageRepository)
    private readonly messageRepo: AssistantMessageRepository,
    @Inject(RedisService)
    private readonly redisService: RedisService,
    @Inject(NestPinoLogger)
